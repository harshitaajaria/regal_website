    ...
    <>
      <div className="content-wrapper">
              ...
              <div className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                ...
                <div className="offcanvas-body d-lg-none order-4 mt-auto">
                  <div className="offcanvas-footer">
                    <div>
                      <Link
                        href="mailto:admin@regaloutsourceindia.com"
                        className="admin@regaloutsourceindia.com"
                      >
        ...
        <section
          ...
          data-image-src="./assets/img/photos/bg26.png"
        >
          ...
          <div className="container pb-14 pb-md-16">
            ...
            <div className="row gx-lg-8 gx-xl-12 gy-6 mb-10 align-items-center">
              <div className="col-lg-6 order-lg-2">
                <ul className="progress-list">
                  ...
                  <li>
                    <p>Cost</p>
                    <div
                      className="progressbar line green"
                      data-value="30"
                    ></div>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <div
                      className="progressbar line purple"
                      data-value="99"
                    ></div>
                  </li>
                </ul>
              ...
              <div className="col-lg-6">
                <h2>Key Features</h2>
                <p>
                  Business Process Outsourcing (BPO) services at Regal Outsource
                  are aimed at making your business more efficient and
                  effective. Our domain expertise, well-trained team and the
                  latest technological support will closely work with your teams
                  at all levels ensuring Link superior delivery of services. Our
                  quality service, meticulous execution and smooth
                  implementation for all your projects will certainly add value
                  and provide you strategic advantage over competition.
                </p>
              </div>
            </div>
            ...
            <div className="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center">
              <div className="col-md-4 col-lg-4">
                ...
                <p className="mb-2">
                  In todays fast-faced world, what really matters is the speed
                  of response and turnaround time. Our dedicated experts with
                  their global expertise and understanding offer the benefits of
                  Link quick turnaround leading to sizeable business gains for
                  you.
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-4">
                ...
                <h4>Management</h4>
                <p className="mb-2">
                  The work at Regal happens with an amalgamation of expert
                  US-based Project Managers along with our unmatched management
                  strategies and policies, dedicated and focused professional
                  teams; you can realize considerable benefits in less than 30
                  days.
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-4">
                ...
                <p className="mb-2">
                  Our baby steps are growing into big leaps everyday with
                  testimonials that are more than satisfactory from our
                  clientele including the older and the newer ones. Our clients
                  continue to benefit from our consistency of operational
                  procedures that are inline with global best practices helping
                  them in increasing their bottom lines.
                </p>
              </div>
            </div>
            <div className="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center mt-10">
              <div className="col-md-4 col-lg-4">
                ...
                <h4>Cost</h4>
                <p className="mb-2">
                  Being engaged in Link Global Delivery Model; we offer highly
                  cost- effective solutions. Our approach is on aim to reduce
                  cost, maintenance and administration. Our teams offer superior
                  cost advantage to our esteemed clients.
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-4">
                ...
                <p className="mb-2">
                  Highly proficient team delivering tailored solutions as per
                  the international standards and global requirements, effective
                  use of technology coupled with Link strong technical
                  expertise.
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-4">
                ...
                <p className="mb-2">
                  Our infrastructure is designed for 100+ full-time employees &
                  24x7 operations. Considering the security & sensitivity we
                  ensure that NO unauthorized access to facilities and
                  equipment, strategically installed CCTV cameras, biometric
                  authentication ensures Link superior and consistent security
                  protocol.
                </p>
              </div>
            </div>
              ...
              <div className="col-lg-5">
                ...
                <div className="d-flex flex-row mb-4">
                  ...
                  <div>
                    ...
                    <p className="mb-1">
                      At Regal Outsource, our commitment to client satisfaction
                      surpasses all standards of excellence and transparency.{" "}
                    </p>
                    <p>
                      {" "}
                      Our clients in the past have actively chosen us for the
                      expertise and professionalism of our people and
                      outsourcing experience. At Regal, we make all efforts to
                      become reliable advisors to our clients.
                    </p>
                  </div>
                </div>
                <div className="d-flex flex-row mb-4">
                  ...
                  <div>
                    ...
                    <p className="mb-1">
                      Regal Outsource provides end-to-end solutions for any
                      business by adopting the latest technology along with
                      market trend by accepting rigorous challenging task in the
                      Domain, Software design, Programming, Implementations and
            ...
            <div className="col-lg-5">
              ...
              <div className="d-flex flex-row">
                ...
                <div>
                  ...
                  <address>
                    Regal Outsource (India) Private Limited F-39(B), I.T.Park,
                    M.I.A. (Extn.),Madri Udaipur - 313003, Rajasthan, India
                  </address>
                </div>
              </div>
              <div className="d-flex flex-row">
