...
const page = () => {
  return (
      ...
      <div class="container pt-17 pb-19 pt-md-18 pb-md-17 text-center">
        <div class="row">
          <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto" data-cues="slideInDown" data-group="page-title">
            <h1 class="display-1 text-white fs-60 mb-4 px-md-15 px-lg-0">Join Our Team</h1>
            <p class="lead fs-24 text-white lh-sm mb-7 mx-md-13 mx-lg-10">Join our team to help shape the future of development.</p>
    ...
    <section class="wrapper bg-light">
      <div class="container pb-15 pb-md-17 mt-15">
      ...
      <div class="container py-14 py-md-16">
        <div class="row">
          <div class="col-lg-10 col-xl-9 col-xxl-8 mx-auto text-center">
            ...
            <a href="./contact2.html" class="btn btn-lg btn-primary rounded-pill">Contact Us</a>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
